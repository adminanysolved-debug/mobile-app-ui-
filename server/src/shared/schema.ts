...
export const users = pgTable("users", {
  ...
  isIntroductoryApplied: boolean("is_introductory_applied").default(false),
  maxPersonalDreams: integer("max_personal_dreams").default(10),
  maxTeamDreams: integer("max_team_dreams").default(1),
  maxChallengeDreams: integer("max_challenge_dreams").default(3),
...
export const marketItems = pgTable("market_items", {
  ...
  imageUrl: text("image_url"),
  price: integer("price"),
  howToAchieve: text("how_to_achieve"),
